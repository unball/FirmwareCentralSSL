...
float* calc_speed_2_motor(float x_dot, float y_dot, float theta_dot){
  float u1 = (1/r)*(theta_dot*(-l-w)+x_dot-y_dot);
  float u2 = (1/r)*(theta_dot*(l+w)+x_dot+y_dot);
  float u3 = (1/r)*(theta_dot*(l+w)+x_dot-y_dot);
  float u4 = (1/r)*(theta_dot*(-l-w)+x_dot+y_dot);
